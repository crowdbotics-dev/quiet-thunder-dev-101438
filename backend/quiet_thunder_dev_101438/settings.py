"""
Django settings for quiet_thunder_dev_101438 project.
...
ROOT_URLCONF = 'quiet_thunder_dev_101438.urls'
...
WSGI_APPLICATION = 'quiet_thunder_dev_101438.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_thunder_dev_101438 API",
    "DESCRIPTION": "API documentation for quiet_thunder_dev_101438 App",
    "VERSION": "v1",
}
